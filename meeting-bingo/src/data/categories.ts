...
// Buzzword packs. Each category has well over 24 words so cards can regenerate
// with fresh variety (plan §3 Phase 1). Words are kept human-readable; detection
// normalizes them with .toLowerCase() at match time (Phase 3).
